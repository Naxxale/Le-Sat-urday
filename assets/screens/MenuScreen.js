    ...
    <div class="container-fluid" style = "background-image: url('assets/img/menu/bg.jpeg');">
        ...
        <div class="my-4">
          ...
          <table class="border-top border-ternary border-2 mx-auto table table-borderless w-75">
            <tbody>
              <tr>
                <td class="col-10 text-center text-secondary bg-primary">Raclette-stick</td>
                <td class="col-2 text-center text-secondary bg-primary">6€</td>
              </tr>
              <tr>
                <td class="text-center text-secondary bg-primary">Raclette-stick</td>
                <td class="text-center text-secondary bg-primary">12€</td>
              </tr>
              <tr>
                <td class="text-center text-secondary bg-primary">Plateau de fromages</td>
        ...
        <div id="rightPart" class="col-6 border-start border-1 border-ternary">
          ...
          <div class="my-4">
            ...
            <table class="border-top border-ternary border-2 mx-auto table table-borderless w-75">
              <tbody>
                <tr>
                  <td class="col-10 text-center text-secondary bg-primary">Cheese Burger</td>
                  <td class="col-2 text-center text-secondary bg-primary">8€</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td class="text-center text-secondary bg-primary">Fish and Chips</td>
                  <td class="text-center text-secondary bg-primary">10€</td>
                </tr>
                <tr>
          ...
          <div class="mt-4">
            ...
            <table class="border-top border-ternary border-2 mx-auto table table-borderless w-75">
              <tbody>
                ...
                <tr>
                  <td class="text-center text-secondary bg-primary">Mousse au chocolat</td>
                  <td class="text-center text-secondary bg-primary">6€</td>
                </tr>
                <tr>
                  <td class="text-center text-secondary bg-primary">Tiramisu</td>
                  <td class="text-center text-secondary bg-primary">6€</td>
                </tr>
                <tr>
                  <td class="text-center text-secondary bg-primary">Tartelette au chocolat</td>
                  <td class="text-center text-secondary bg-primary">6€</td>
                </tr>
                <tr>
                  <td class="text-center text-secondary bg-primary">Crème brûlée</td>
